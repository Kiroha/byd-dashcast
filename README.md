...
| 12 | **Journal temps réel** | LogActivity — niveaux DEBUG/INFO/WARN/ERROR, filtres, Azure export |
| 13 | **☁ Azure Export** | Push vers Azure Log Analytics (HMAC-SHA256, table `BYDAppLog_CL`) |
...
├── AzureLogExporter.java       — HTTP Data Collector → Azure Log Analytics
├── LogActivity.java            — Journal temps réel (filtres, auto-scroll, Azure)
...
azure.primary.key=<clé primaire Azure>
```
...
### Requêtes KQL Azure (workspace `law-byd-app`, francecentral)
